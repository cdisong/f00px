...
photo2 = Photo.create!(description: "West to UCLA", author_id: user3.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845945/westtoucla.png")
photo3 = Photo.create!(description: "City Park", author_id: user5.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845937/citypark.png")
photo4 = Photo.create!(description: "Here be dragons.", author_id: demouser.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845910/herebedragons.png")
photo5 = Photo.create!(description: "Zion Canyon", author_id: demouser.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845910/zionredwalls.png")
photo36 = Photo.create!(description: "Portland Dusk", author_id: user4.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511892806/portlanddusk.png")
photo6 = Photo.create!(description: "UCLA jungle", author_id: demouser.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845894/uclajungle.png")
...
photo9 = Photo.create!(description: "Cold Portland Mountains", author_id: user8.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511898158/coldmountain.png")
photo10 = Photo.create!(description: "Tree Texture", author_id: demouser.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845819/itchyteeth.png")
photo11 = Photo.create!(description: "Solitude", author_id: demouser.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845794/solitude.png")
photo12 = Photo.create!(description: "Babbling Brooks", author_id: user7.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845780/babblingbrook.png")
photo13 = Photo.create!(description: "Tree-made Tunnels", author_id: user1.id, image_url: "http://res.cloudinary.com/cdisong/image/upload/v1511845764/treetunnel.png")
